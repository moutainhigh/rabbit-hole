...
import in.hocg.rabbit.sso.config.security.handler.AjaxAccessDeniedHandler;
import in.hocg.rabbit.sso.config.security.handler.AjaxAuthenticationEntryPoint;
import in.hocg.rabbit.sso.config.security.helper.IsAjaxRequestMatcher;
...
public class WebSecurityConfigurer extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
            ...
            .antMatchers("/login", "/login/*", "/account/login/token", "/account/login/qrcode", "/account/login/qrcode/confirm").permitAll()
