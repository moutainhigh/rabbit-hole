package in.hocg.rabbit.sso.config.security.config;

import in.hocg.rabbit.sso.config.security.helper.PageConstants;
import in.hocg.rabbit.sso.config.security.handler.AuthorizedFailureHandle;
import in.hocg.rabbit.sso.config.security.handler.AuthorizedSuccessHandle;
import in.hocg.rabbit.sso.config.security.support.social.CustomAuthenticationSuccessHandler;
import in.hocg.rabbit.sso.config.security.support.social.CustomOAuth2UserService;
