...
VALUES ('不思议迷宫(密令)',
        ...
        '/pages/feature/gumballs/index',
        '不思议迷宫的密令', '游戏;不思议迷宫;密令',
...
VALUES ('文字字体',
        ...
        '/pages/feature/roar/index',
        '做一个有感情的文字', '字体;朋友圈;微信', DEFAULT,
        '2021-01-01 22:10:41.000000', 0, null, null, DEFAULT);
...
VALUES ('帮你百度一下',
        ...
        '/pages/feature/helpso/index',
        '老是问有的没的，我来帮你', '搜索;提问狂;百度', DEFAULT,
        '2021-01-01 22:10:41.000000', 0, null, null, DEFAULT);
